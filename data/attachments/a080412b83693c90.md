...
- Name: api\users\user-create.spec.ts >> ユーザー作成
- Location: tests\api\users\user-create.spec.ts:15:5

# Error details

```
Error: apiRequestContext.post: getaddrinfo ENOTFOUND dummyjson.comusers
Call log:
  - → POST https://dummyjson.comusers/add
...
```ts
  ...
  62  | 
  63  |     //PATCH
  64  |     protected async patch(
  65  |         endpoint: string,
  66  |         body?: any,
  67  |         headers: Record<string, string> = {}
  68  |     ) {
  69  |         return await this.send(
  70  |             "PATCH",
  71  |             endpoint,
  72  |             body,
  73  |             headers
